...
#'
#' @references
#' Bjornstad, O. N., and W. Falck. 2001. Nonparametric spatial covariance
#' functions: Estimation and testing. \emph{Environmental and Ecological
#' Statistics} 8:53-70.
#'
...
#' \emph{Trends in Ecology & Evolution} 14:427-432.
#'
...
#'
#' Fortin, M. J., and M. R. T. Dale. 2005. Spatial Analysis: A Guide for
#' Ecologists. Cambridge University Press.
#'
#' Gouhier, T. C., and F. Guichard. 2007. Local disturbance cycles and the
#' maintenance of spatial heterogeneity across scales in marine metapopulations.
#' \emph{Ecology} 88:647-657.
#'
#' Gouhier, T. C., F. Guichard, and A. Gonzalez. 2010. Synchrony and stability
#' of food webs in metacommunities. \emph{The American Naturalist} 175:E16-E34.
#'
...
.onAttach <- function(libname, pkgname) {
  ...
  message <- paste("synchrony", utils::packageVersion("synchrony"), "loaded.")
